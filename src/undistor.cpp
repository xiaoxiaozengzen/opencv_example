...
int main() {
    ...
    std::cout << "======================== surround_left_undistort ========================" << std::endl;
    surround_left_undistort();
    std::cout << "======================== surround_rear_undistort ========================" << std::endl;
    surround_rear_undistort();
    std::cout << "======================== surround_right_undistort ========================" << std::endl;
    surround_right_undistort();
